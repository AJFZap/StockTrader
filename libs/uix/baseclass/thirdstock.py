...
openPrice = [thing.openPrice['GOOGL']]
times = [0]
stockPrice = [thing.currentStockPrice['GOOGL']]
...
ax.legend(ncol= 2,bbox_to_anchor = (0.5,1.15),loc='upper center')
...
class ThirdStock(Screen):
    ...
    def UpdateGraph(self, time):
      ...
      stockPrice.append(thing.currentStockPrice['GOOGL'])
